...
set EXTRA_CMAKE_ARGUMENTS (string match -v -- "-DFEATURE_precompile_header=OFF" $EXTRA_CMAKE_ARGUMENTS)
...
set -p EXTRA_CMAKE_ARGUMENTS "-DFEATURE_precompile_header=OFF"
